...
export const timelineItems: TimelineItem[] = [
  {
    ...
    description: "Specialized in IT architecture and system design through hands-on professional training focused on projects."
  },
  {
    id: 2,
    side: "left",
    ...
    description: "Led communication initiatives during the pandemic, managing projects to enhance visibility for a family-run producer."
  },
  {
    id: 3,
    side: "right",
    ...
    description: "Specialized in sustainable development and destination marketing strategies."
  },
  {
    id: 4,
    side: "left",
    ...
    description: "Managed communication strategies and coordinated initiatives to improve company visibility."
  },
  {
    id: 5,
    side: "right",
  ...
  },
  {
    ...
    description: "Focused on generative grammar and Chomsky’s language structure theories."
  }
];
